...
public class LabClass
{
     ...
     * 
     * @param maxNumberOfStudents The maximum number of students in the class
     */
     ...
     * 
     * @param setRoom The room number the class is to be assigned to
     */
     ...
     * 
     * @param timeAndDayString The time and day in a string format
     */
